...
class Waveform(DPT.DPObject):
    ...
    def plot(self, i = None, ax = None, getNumEvents = False, getLevels = False,\
        ...
        # Returns the array dict sorted on the value
        def getSortedArrayDict():
        ...
        if getNumEvents:  
            if self.current_plot_type == plot_type:
                ...
                return self.numSets, getSortedArrayDict()[i-1][1] + 1                
                ...
                array_num = 0
                for (k, v) in getSortedArrayDict():
                    if i <= v:
                        return len(self.array_dict), array_num
                    array_num += 1
        ...
        if plot_type == 'Channel':
            ...
            while currch <= cend :
                ...
                currch += 1
            suptitle = self.dirs[cstart] + "-" + self.dirs[cend][-3:]
            fig.suptitle(suptitle)
        self.current_plot_type = plot_type
        plotOpts['TitleOff'] = False
        return ax
